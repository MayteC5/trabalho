...
class AssuntoResourceIT {
    ...
    private static final Integer DEFAULT_IDPROFESSOR = 1;
    private static final Integer UPDATED_IDPROFESSOR = 2;
    ...
    public static Assunto createEntity(EntityManager em) {
        Assunto assunto = new Assunto()
            .codigoassunto(DEFAULT_CODIGOASSUNTO)
            .nome(DEFAULT_NOME)
            .carga(DEFAULT_CARGA)
            .idprofessor(DEFAULT_IDPROFESSOR);
        return assunto;
    }
    ...
    public static Assunto createUpdatedEntity(EntityManager em) {
        Assunto assunto = new Assunto()
            .codigoassunto(UPDATED_CODIGOASSUNTO)
            .nome(UPDATED_NOME)
            .carga(UPDATED_CARGA)
            .idprofessor(UPDATED_IDPROFESSOR);
        return assunto;
    }
    ...
    void createAssunto() throws Exception {
        ...
        assertThat(testAssunto.getIdprofessor()).isEqualTo(DEFAULT_IDPROFESSOR);
    }
    ...
    @Test
    @Transactional
    void checkIdprofessorIsRequired() throws Exception {
        int databaseSizeBeforeTest = assuntoRepository.findAll().size();
        // set the field null
        assunto.setIdprofessor(null);
    ...
    void getAllAssuntos() throws Exception {
        ...
        restAssuntoMockMvc
            ...
            .andExpect(jsonPath("$.[*].idprofessor").value(hasItem(DEFAULT_IDPROFESSOR)));
    }
    ...
    void getAssunto() throws Exception {
        ...
        restAssuntoMockMvc
            ...
            .andExpect(jsonPath("$.idprofessor").value(DEFAULT_IDPROFESSOR));
    }
    ...
    void putNewAssunto() throws Exception {
        ...
        updatedAssunto.codigoassunto(UPDATED_CODIGOASSUNTO).nome(UPDATED_NOME).carga(UPDATED_CARGA).idprofessor(UPDATED_IDPROFESSOR);
        ...
        assertThat(testAssunto.getIdprofessor()).isEqualTo(UPDATED_IDPROFESSOR);
    }
    ...
    void partialUpdateAssuntoWithPatch() throws Exception {
        ...
        partialUpdatedAssunto.codigoassunto(UPDATED_CODIGOASSUNTO).idprofessor(UPDATED_IDPROFESSOR);
    ...
    void fullUpdateAssuntoWithPatch() throws Exception {
        ...
        partialUpdatedAssunto.codigoassunto(UPDATED_CODIGOASSUNTO).nome(UPDATED_NOME).carga(UPDATED_CARGA).idprofessor(UPDATED_IDPROFESSOR);
